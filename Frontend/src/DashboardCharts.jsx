...
import SkillRadarChart from './SkillRadarChart'; // ดึงชิ้นส่วนกราฟเดี่ยวมาใช้
...
export default function DashboardCharts({ userId }) {
    return (
        <div style={{ maxWidth: '1200px', margin: '0 auto 40px auto', width: '100%' }}>
            ...
            {/* จัดเรียง 3 กราฟเป็น 3 คอลัมน์ด้วย CSS Grid */}
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '20px', padding: '0 20px' }}>
